...
<body style="margin:0;padding:0;background-color:#f0f4ff;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;">
  <div style="max-width:560px;margin:40px auto;background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 12px rgba(0,70,200,0.12);border:2px solid #1a6aff;">
    <div style="background:linear-gradient(135deg,#0046c8,#1a6aff,#4d94ff);padding:28px 24px;text-align:center;">
      <h1 style="color:#ffffff;font-size:20px;margin:0;font-weight:700;letter-spacing:-0.3px;">${subject}</h1>
    </div>
    <div style="padding:28px 24px;font-size:15px;color:#1e293b;line-height:1.7;">
      ${emailBody}
    </div>
    <div style="padding:16px 24px;background:linear-gradient(135deg,#e8f0fe,#f0f4ff);text-align:center;border-top:2px solid #1a6aff;">
      <p style="font-size:12px;color:#1a6aff;margin:0;font-weight:600;">Sent via CushyInvoice</p>
    </div>
  </div>
</body>
</html>`;
