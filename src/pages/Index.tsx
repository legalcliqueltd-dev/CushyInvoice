    ...
    <div className="min-h-screen bg-background landing-noise overflow-x-hidden">
      ...
      <section className="container mx-auto px-4 py-12 sm:py-20 lg:py-32 relative">
        ...
        <img
          ...
          alt=""
          aria-hidden="true"
          className="absolute right-4 sm:right-12 lg:right-24 top-1/2 -translate-y-1/2 w-48 sm:w-64 lg:w-80 opacity-15 sm:opacity-20 rotate-6 pointer-events-none select-none"
        />
