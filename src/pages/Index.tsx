  ...
  return (
    <div className="min-h-screen bg-background landing-noise overflow-x-hidden">
      ...
      <section className="container mx-auto px-4 py-12 sm:py-20 lg:py-32 relative">
        {/* Decorative invoice — behind text with overlap */}
        <img
          src={heroInvoice}
          alt=""
          aria-hidden="true"
          className="absolute right-1/2 translate-x-1/2 top-[55%] -translate-y-1/2 w-[600px] sm:w-[900px] lg:w-[1100px] opacity-10 sm:opacity-[0.12] rotate-6 pointer-events-none select-none"
        />
