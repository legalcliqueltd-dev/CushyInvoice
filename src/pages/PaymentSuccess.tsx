...
export default function PaymentSuccess() {
  ...
  // If invoiceId is present and no session_id, this is a public invoice payment (no auth needed)
  ...
  // For public invoice payments, don't wrap in DashboardLayout (no auth required)
